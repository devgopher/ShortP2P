...
Клиентское приложение на **.NET MAUI** (сейчас в решении настроен таргет **Windows**; в `.csproj` указано, как добавить Android/iOS/Mac Catalyst после `dotnet workload restore`). Использует `ShortP2P.Client` как общую логику.
