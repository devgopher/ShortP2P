...
Десктопное приложение **Windows Forms** (.NET 8, Windows): UI для чатов, локального сканирования, QR, настроек маршрутизации, входа и регистрации. Подключает клиентскую логику и Bluetooth-транспорт Windows.
