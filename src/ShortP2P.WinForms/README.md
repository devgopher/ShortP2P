...
Десктопное приложение **Windows Forms** (.NET 10, Windows): UI для чатов, локального сканирования, QR, настроек маршрутизации, входа и регистрации. Подключает клиентскую логику и Bluetooth-транспорт Windows.
